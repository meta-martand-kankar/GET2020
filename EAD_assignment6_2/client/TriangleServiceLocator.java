...
public class TriangleServiceLocator extends org.apache.axis.client.Service implements soapProject.TriangleService {
    ...
    private java.lang.String Triangle_address = "http://localhost:8080/Assignment_5_2_a/services/Triangle";
    ...
    public soapProject.Triangle getTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soapProject.TriangleSoapBindingStub _stub = new soapProject.TriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soapProject.Triangle.class.isAssignableFrom(serviceEndpointInterface)) {
                soapProject.TriangleSoapBindingStub _stub = new soapProject.TriangleSoapBindingStub(new java.net.URL(Triangle_address), this);
                _stub.setPortName(getTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soapProject", "TriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soapProject", "Triangle"));
        }
